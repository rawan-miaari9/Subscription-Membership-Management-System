...
urlpatterns = [
    ...
    path("invoices/<int:pk>/status/", views.invoice_status_view, name="invoice-status"),
    ...
    path("notifications/<str:nkey>/read/", views.notification_mark_read_view, name="notification-mark-read"),
    ...
    path("refunds/create/", views.refund_create_view, name="refund-create"),
    path("refunds/<int:pk>/", views.refund_detail_view, name="refund-detail"),
    path("refunds/<int:pk>/status/", views.refund_status_view, name="refund-status"),
    ...
    path("receipts/<int:pk>/edit/", views.receipt_edit_view, name="receipt-edit"),
    path("receipts/<int:pk>/pdf/", views.receipt_pdf_view, name="receipt-pdf"),
    path("receipts/<int:pk>/delete/", views.receipt_delete_view, name="receipt-delete"),
